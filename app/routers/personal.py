...
from app.core.deps import get_current_user, require_admin_only
...
async def actualizar_personal(
    ...
    # Actualizar un personal existente en la base de datos (Solo Administrador)
...
async def registrar_usuario_personal(
    ...
    # Asignar credenciales de acceso (Usuario) a un personal existente (Solo Administrador)
...
async def actualizar_usuario_personal(
    ...
    # Actualizar credenciales de acceso (Usuario) de un personal existente (Solo Administrador)
...
async def registrar_personal(
    ...
    # Registrar un nuevo personal en la base de datos (Solo Administrador)
...
async def desactivar_personal(
    ...
    # Desactivar (borrado lógico) o eliminar definitivamente a un trabajador (Solo Administrador)
